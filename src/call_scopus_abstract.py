...
def abstract_dataframe(hrefs):
    ...
    for i in range(0, len(hrefs)):
        ...
        try:
            article["title"] = json_obj["full-text-retrieval-response"]["coredata"][
                "dc:title"
            ]
        except:
            pass
        ...
        try:
            article["creators"] = [
                i["$"]
                for i in json_obj["full-text-retrieval-response"]["coredata"][
                    "dc:creator"
                ]
            ]
        except KeyError:
            ...
            article["creators"] = json_obj["full-text-retrieval-response"]["coredata"][
                "dc:creator"
            ]["$"]
        ...
        try:
            ...
            article["subjects"] = json_obj["full-text-retrieval-response"]["coredata"][
                "dcterms:subject"
            ]["$"]

        try:
            article["description"] = json_obj["full-text-retrieval-response"][
                "coredata"
            ]["dc:description"]
        except KeyError:
        ...
        try:
            article["publicationName"] = json_obj["full-text-retrieval-response"][
                "coredata"
        ...
        try:
            article["date"] = json_obj["full-text-retrieval-response"]["coredata"][
                "prism:coverDate"
            ]
        except KeyError:
            article["date"] = 0
